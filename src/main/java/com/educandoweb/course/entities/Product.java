...
public class Product implements Serializable{
	...
	@JoinTable(name = "tb_product_category", // What is the name of the table and which will be foreign keys that will associate the table product with the table category
